...
namespace AFManager
{
	public class ClientCertValidator : X509CertificateValidator
	{
		...
		public override void Validate(X509Certificate2 certificate)     // serverov sertifikat
		{
			// sam sebi izdao sertifikat
		...
		// Na klijentskoj strani se validira serverski sertifikat
	}
}
